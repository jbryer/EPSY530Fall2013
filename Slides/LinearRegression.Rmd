...
```{r scatterplot, tidy=FALSE, fig.width=9, fig.height=6}
...
```{r scatterzscores, tidy=FALSE, fig.width=9, fig.height=6}
...
$$b = \overline{x} - m \overline{y} = \overline{SAT_{math}} - m \overline{SAT_{verbal}}$$
...
```{r scatterwithregressionline, tidy=FALSE, fig.width=9, fig.height=6}
ggplot(sat, aes(x=Verbal, y=Math)) + geom_point(color='black') +
...
```{r scatterwithresiduals, tidy=FALSE, fig.width=9, fig.height=6}
ggplot(sat, aes(x=Verbal, y=Math)) + geom_point(color='black') +
	geom_abline(intercept=b, slope=m, color='red', size=2, alpha=.5) +
...
```{r sumofsquares, tidy=FALSE, fig.width=9, fig.height=6}
...
```{r scatterbadmodel, tidy=FALSE, fig.width=9, fig.height=6}
b.bad <- results[1,]$b
m.bad <- results[1,]$m
...
```{r residualplot, tidy=FALSE, fig.width=9, fig.height=6}
...
```{r residualplot2, tidy=FALSE, fig.width=9, fig.height=6}
...
```{r histogramofresiduals, tidy=FALSE, fig.width=9, fig.height=4}
...
```{r predictnew, tidy=FALSE, fig.width=9, fig.height=6}
newX <- 550
(newY <- newX * m + b)
ggplot(sat, aes(x=Verbal, y=Math)) + geom_point(color='black') +
	geom_abline(intercept=b, slope=m, color='red', size=2, alpha=.5) +
...
```{r scattergender, tidy=FALSE, fig.width=9, fig.height=6}
...
```{r residualgender, tidy=FALSE, fig.width=9, fig.height=6}
ggplot(sat) + 
...
```{r residualhistogramgender, tidy=FALSE, fig.width=9, fig.height=6}
...
```{r scattergenderregression, tidy=FALSE, fig.width=9, fig.height=6}
...
```{r histogramoutlier, tidy=FALSE, fig.width=9, fig.height=4}
...
```{r scatteroutlier, tidy=FALSE, fig.width=9, fig.height=6}
...
```{r scatteroutlier1, tidy=FALSE, fig.width=9, fig.height=6}
outX <- 1200
outY <- 1150
...
```{r scatteroutlier1=2, tidy=FALSE, fig.width=9, fig.height=6}
outX <- 300
outY <- 1150
sat.outlier <- rbind(sat[,c('Verbal','Math')], c(Verbal=outX, Math=outY))
(sat.lm <- lm(Math ~ Verbal, data=sat))
